...
import com.jenkov.generated.FilterBenchmark_jmhType;
import com.jenkov.generated.FilterBenchmark_StartUpState_jmhType;
public final class FilterBenchmark_testMethod_jmhTest {
    ...
    public BenchmarkTaskResult testMethod_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            FilterBenchmark_jmhType l_filterbenchmark0_0 = _jmh_tryInit_f_filterbenchmark0_0(control);
            FilterBenchmark_StartUpState_jmhType l_startupstate1_G = _jmh_tryInit_f_startupstate1_G(control);
            ...
            while (control.warmupShouldWait) {
                l_filterbenchmark0_0.testMethod(l_startupstate1_G, blackhole);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            testMethod_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_startupstate1_G, l_filterbenchmark0_0);
    ...
    public static void testMethod_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, FilterBenchmark_StartUpState_jmhType l_startupstate1_G, FilterBenchmark_jmhType l_filterbenchmark0_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult testMethod_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            testMethod_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_startupstate1_G, l_filterbenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult testMethod_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            testMethod_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_startupstate1_G, l_filterbenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void testMethod_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, FilterBenchmark_StartUpState_jmhType l_startupstate1_G, FilterBenchmark_jmhType l_filterbenchmark0_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult testMethod_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            testMethod_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_startupstate1_G, l_filterbenchmark0_0);
            control.preTearDown();
    ...
    public static void testMethod_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, FilterBenchmark_StartUpState_jmhType l_startupstate1_G, FilterBenchmark_jmhType l_filterbenchmark0_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile FilterBenchmark_StartUpState_jmhType f_startupstate1_G;
    
    FilterBenchmark_StartUpState_jmhType _jmh_tryInit_f_startupstate1_G(InfraControl control) throws Throwable {
        FilterBenchmark_StartUpState_jmhType val = f_startupstate1_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            ...
            val = new FilterBenchmark_StartUpState_jmhType();
            val.readyTrial = true;
    ...
    FilterBenchmark_jmhType f_filterbenchmark0_0;
    
    FilterBenchmark_jmhType _jmh_tryInit_f_filterbenchmark0_0(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        FilterBenchmark_jmhType val = f_filterbenchmark0_0;
        if (val == null) {
            val = new FilterBenchmark_jmhType();
            f_filterbenchmark0_0 = val;
        }
        return val;
    }
